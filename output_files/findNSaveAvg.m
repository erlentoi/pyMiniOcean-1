...
nccreate(filename,'T_avg','Datatype','double','Dimensions',{'xc','yc','zc'})
nccreate(filename,'T_std','Datatype','double','Dimensions',{'xc','yc','zc'})

nccreate(filename,'S_avg','Datatype','double','Dimensions',{'xc','yc','zc'})
nccreate(filename,'S_std','Datatype','double','Dimensions',{'xc','yc','zc'})

nccreate(filename,'E_avg','Datatype','double','Dimensions',{'xc','yc'})
nccreate(filename,'E_std','Datatype','double','Dimensions',{'xc','yc'})
...
%%
%mean
ncwrite('stateAvgStd.nc','U_avg',reshape(U_avg,[xc-1,yc,zc]))
ncwrite('stateAvgStd.nc','V_avg',reshape(V_avg,[xc,yc-1,zc]))

ncwrite('stateAvgStd.nc','T_avg',reshape(T_avg,[xc,yc,zc]))
ncwrite('stateAvgStd.nc','S_avg',reshape(S_avg,[xc,yc,zc]))
ncwrite('stateAvgStd.nc','E_avg',reshape(E_avg,[xc,yc]))

ncwrite('stateAvgStd.nc','windU_avg',reshape(windU_avg,[xc-1,yc]))
ncwrite('stateAvgStd.nc','windV_avg',reshape(windV_avg,[xc,yc-1]))
...
%%
%std
ncwrite('stateAvgStd.nc','U_std',reshape(U_std,[xc,yc-1,zc]))
ncwrite('stateAvgStd.nc','V_std',reshape(V_std,[xc-1,yc,zc]))
